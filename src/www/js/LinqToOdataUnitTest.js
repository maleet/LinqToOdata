        ...
        var queryable = new BoostJS.Queryable(metadata.BpBuyFrom, undefined, metadata)
            ...
            .expand(function (bpBuyFrom) {
                return [
                    ...
                    bpBuyFrom.BusinessPartner.select(function (bp) {
                        return [bp.Name, bp.Code];
                    }),
                    bpBuyFrom.BusinessPartner.BpInvoiceFrom.select(function (bp) {
                        return [bp.Name, bp.Code];
                    }),
...
//        runs(function(){
//
//            var orderBy = BoostJS.Expression.orderBy(BoostJS.Expression.descending(BoostJS.Expression.property("propertyName")),
// BoostJS.Expression.ascending(BoostJS.Expression.property("propertyName1")));  expect(orderBy.children[0].name).toEqual("descending");
// expect(orderBy.children[1].name).toEqual("ascending"); expect(orderBy.children[0].children[0].name).toEqual("property");
// expect(orderBy.children[1].children[0].name).toEqual("property"); expect(orderBy.children[0].children[0].value).toEqual("propertyName");
// expect(orderBy.children[1].children[0].value).toEqual("propertyName1"); }); });  });  describe("Skip method expression.", function(){  it("We skip 2.", function(){
// runs(function(){  var skip = BoostJS.Expression.skip(BoostJS.Expression.getExpressionType(2));  expect(skip.children[0].name).toEqual("number");
// expect(skip.children[0].value).toEqual(2); }); });  });   describe("Take method expression.", function(){  it("We will take 5.", function(){ runs(function(){  var take =
// BoostJS.Expression.take(BoostJS.Expression.getExpressionType(5));  expect(take.children[0].name).toEqual("number"); expect(take.children[0].value).toEqual(5); }); });  });
// describe("ToGuid method expression.", function(){  it("We will make a guid.", function(){ runs(function(){  var guid =
// BoostJS.Expression.toGuid(BoostJS.Expression.getExpressionType("12sl3cl3-0dkdl"));  expect(guid.children[0].name).toEqual("string");
// expect(guid.children[0].value).toEqual("12sl3cl3-0dkdl"); }); });  });  describe("Substring method expression.", function(){  it("We will make a substring method with \"arn\"
// as the argument.", function(){ runs(function(){  var substring = BoostJS.Expression.substring(BoostJS.Expression.property("firstName"),
// BoostJS.Expression.getExpressionType("arn"));  expect(substring.children[0].name).toEqual("property"); expect(substring.children[0].value).toEqual("firstName");
// expect(substring.children[1].name).toEqual("string"); expect(substring.children[1].value).toEqual("arn"); }); });  });  describe("SubstringOf method expression.", function(){
// it("We will make a substringOf method with \"are\" as the argument.", function(){ runs(function(){  var substringOf =
// BoostJS.Expression.substringOf(BoostJS.Expression.property("firstName"), BoostJS.Expression.getExpressionType("are"));
// expect(substringOf.children[0].name).toEqual("property"); expect(substringOf.children[0].value).toEqual("firstName");  expect(substringOf.children[1].name).toEqual("string");
// expect(substringOf.children[1].value).toEqual("are"); }); });  });  describe("StartsWith method expression.", function(){  it("We will make a startsWith method with \"Jar\" as
// the argument.", function(){ runs(function(){  var startsWith = BoostJS.Expression.startsWith(BoostJS.Expression.property("firstName"),
// BoostJS.Expression.getExpressionType("Jar"));  expect(startsWith.children[0].name).toEqual("property"); expect(startsWith.children[0].value).toEqual("firstName");
// expect(startsWith.children[1].name).toEqual("string"); expect(startsWith.children[1].value).toEqual("Jar"); }); });  });  describe("EndsWiths method expression.", function(){  it("We will make a endsWith method with \"red\" as the argument.", function(){ runs(function(){  var endsWith = BoostJS.Expression.endsWith(BoostJS.Expression.property("firstName"), BoostJS.Expression.getExpressionType("red"));  expect(endsWith.children[0].name).toEqual("property"); expect(endsWith.children[0].value).toEqual("firstName");  expect(endsWith.children[1].name).toEqual("string"); expect(endsWith.children[1].value).toEqual("red"); }); });  });  describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type Person, and test equals.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.firstName.equals("Jared");  expect(exp.name).toEqual("equal"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("firstName"); expect(exp.children[1].name).toEqual("string"); expect(exp.children[1].value).toEqual("Jared");  }); });  });  describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type circular Person, and test equals.", function(){ runs(function(){  var Person = { firstName: null, lastName: null, age: null };  Person.person = Person;   var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.person.firstName.equals("Jared");  expect(exp.name).toEqual("equal"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("person.firstName"); expect(exp.children[1].name).toEqual("string"); expect(exp.children[1].value).toEqual("Jared"); }); });  });  describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type Person, and test greaterThan.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.age.greaterThan(0);  expect(exp.name).toEqual("greaterThan"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("age"); expect(exp.children[1].name).toEqual("number"); expect(exp.children[1].value).toEqual(0);  }); });  });  describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type Person, and test lessThan.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.age.lessThan(0);  expect(exp.name).toEqual("lessThan"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("age"); expect(exp.children[1].name).toEqual("number"); expect(exp.children[1].value).toEqual(0);  }); });  });   describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type Person, and test greaterThanOrEqualTo.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.age.greaterThanOrEqualTo(0);  expect(exp.name).toEqual("greaterThanOrEqual"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("age"); expect(exp.children[1].name).toEqual("number"); expect(exp.children[1].value).toEqual(0);  }); });  });  describe("ExpressionBuilder", function(){  it("Create a Expression tree through expression builder of type Person, and test lessThanOrEqualTo.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var expressionBuilder = new BoostJS.ExpressionBuilder(Person); var exp = expressionBuilder.age.lessThanOrEqualTo(0);  expect(exp.name).toEqual("lessThanOrEqual"); expect(exp.children[0].name).toEqual("property"); expect(exp.children[0].value).toEqual("age"); expect(exp.children[1].name).toEqual("number"); expect(exp.children[1].value).toEqual(0);  }); });  });  describe("Queryable", function(){  it("Create a Queryable of Type Person, and use a equals with a take, and skip 1.", function(){ runs(function(){  var Person = function(){ this.firstName = null; this.lastName = null; this.age = null; };  var queryable = new BoostJS.Queryable(Person).where(function(p){ return p.firstName.equals("Jared"); }).take(5).skip(1).orderBy(function(p){ return p.lastName; });  var expression = queryable.expression;  expect(expression.where.name).toEqual("where");  expect(expression.skip.children[0].value).toEqual(1); expect(expression.skip.children[0].name).toEqual("number");  expect(expression.take.children[0].name).toEqual("number"); expect(expression.take.children[0].value).toEqual(5);  expect(expression.orderBy.children[0].name).toEqual("ascending"); expect(expression.orderBy.children[0].children[0].name).toEqual("property"); expect(expression.orderBy.children[0].children[0].value).toEqual("lastName");  }); });  });
